...
export function OnboardingChat() {
  ...
  async function streamFromServer(history: Message[]) {
    setStreaming(true);
        ...
        {result ? (
          <div className="rounded-xl border border-emerald-300 dark:border-emerald-800 bg-emerald-50/40 dark:bg-emerald-950/30 p-5">
            ...
            <div className="mt-2 text-sm">
              <div className="font-medium">{result.profileType.replace(/_/g, " ").toLowerCase()}</div>
          ...
          <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 p-5 text-sm">
            <div className="text-zinc-500">
              ...
              <ul className="mt-2 space-y-1 list-disc pl-5">
                <li>Ask about how you earn income</li>
                <li>Cover equity, debts, real estate</li>
                <li>Recommend a profile</li>
